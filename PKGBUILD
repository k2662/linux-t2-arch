...
T2_PATCH_HASH=c91b5d4e166f60c4bc79b156826600f76c7451ae
source=(
  https://github.com/archlinux/linux/archive/refs/tags/v${_pkgver}-arch${archrel}.tar.gz
  config  # the main kernel config file

  # t2linux Patches
  patches::git+https://github.com/k2662/linux-t2-patches
)
validpgpkeys=(
...
sha256sums=('0af90a723f099a2cf02a34e6c45a2c6a98483ea34be6e1b28d56feff2675af5b'
